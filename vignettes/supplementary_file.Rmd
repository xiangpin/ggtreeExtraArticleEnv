...
The source codes and datasets to produce this file can be obtained from the repository^[<https://github.com/YuLab-SMU/plotting-tree-with-data-using-ggtreeExtra>].
...
## subplot B
tr <- read.tree(system.file("extdata","VertebrateGutMicrobiomes/annotated_host_tree.tre", package="ggtreeExtraArticleEnv"))
corda <- read.csv(system.file("extdata","VertebrateGutMicrobiomes/mantel.jaccard.pearson.csv", package="ggtreeExtraArticleEnv"))
corda$r <- abs(corda$r)
barda <- read.csv(system.file("extdata","VertebrateGutMicrobiomes/data_diet_bar.csv",package="ggtreeExtraArticleEnv"), check.names=F)
...
cladeda <- read.csv(system.file("extdata","VertebrateGutMicrobiomes/data_clade_class.csv", package="ggtreeExtraArticleEnv"), check.names=F)
...
flightda <- read.csv(system.file("extdata","VertebrateGutMicrobiomes/data_flight_bar.csv", package="ggtreeExtraArticleEnv"))

phylopicda <- read.csv(system.file("extdata","VertebrateGutMicrobiomes/data_phylopic_uid.csv", package="ggtreeExtraArticleEnv"))
...
library(ggnewscale)
library(tidytree)
tr <- read.raxml(system.file("extdata","Methanotroph/Methanotroph_rpS3_Modified_Alignment_RAxML", package="ggtreeExtraArticleEnv"))
...
alltax <- read.csv(system.file("extdata","Arabidopsis_leaf_microbiome/all_stain_taxonomy.csv", package="ggtreeExtraArticleEnv"))
linktab <- read.csv(system.file("extdata","Arabidopsis_leaf_microbiome/Interaction_link_tab.csv", package="ggtreeExtraArticleEnv"))
weighttab <- read.csv(system.file("extdata","Arabidopsis_leaf_microbiome/Interaction_weight.csv", package="ggtreeExtraArticleEnv"))
tippoint <- read.csv(system.file("extdata","Arabidopsis_leaf_microbiome/stain_tippoint.csv", package="ggtreeExtraArticleEnv"))
BGCsda <- read.csv(system.file("extdata","Arabidopsis_leaf_microbiome/BGCs_heatmap.csv", package="ggtreeExtraArticleEnv"))
